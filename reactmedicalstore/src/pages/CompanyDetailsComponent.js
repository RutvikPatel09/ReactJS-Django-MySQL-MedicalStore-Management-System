                            ...
                            <form method="post" onSubmit={this.formSubmit}>
                                ...
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="name" name="name" className="form-control" placeholder="Enter Company Name" defaultValue={this.state.name}/>
                                    </div>
                                </div>
                                <label htmlFor="email_address">License No.</label>
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="license_no" name="license_no" className="form-control" placeholder="Enter Company License No" defaultValue={this.state.license_no}/>
                                    </div>
                                </div>
                                <label htmlFor="email_address">Address</label>
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="address" name="address" className="form-control" placeholder="Enter Company Address" defaultValue={this.state.address}/>
                                    </div>
                                </div>
                                <label htmlFor="email_address">Contact No.</label>
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="contact_no" name="contact_no" className="form-control" placeholder="Enter Company Contact No" defaultValue={this.state.contact_no}/>
                                    </div>
                                </div>
                                ...
                                <div className="form-group">
                                    <div className="form-line">
                                        <input type="text" id="description" name="description" className="form-control" placeholder="Enter Company Description" defaultValue={this.state.description}/>
                                    </div>
                                </div>
                                <br/>
                                ...
                                <tbody>
                                   {this.state.companyBank.map((company)=>
                                        <tr key={company.id}>
                                            ...
                                            <td>
                                                <button className="btn btn-block btn-warning" onClick={()=>{this.EditCompanyBank(company.id)}}>EDIT</button>
