        ...
        return (
            ...
            <aside id="leftsidebar" className="sidebar">
                    ...
                    <div className="info-container">
                        ...
                        <div className={this.state.defaultClass}>
                            ...
                            <ul className="dropdown-menu pull-right">
                                <li><a href={Config.logoutUrl} className=" waves-effect waves-block" ref={this.divref2}><i className="material-icons">input</i>Sign Out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="menu">
                    ...
                    </ul><div className="slimScrollBar" style={{background: "rgba(0, 0, 0, 0.5)", width: "4px", position: "absolute", top: "0px", opacity: "0.4", display: "none", borderradius: "0px", zindex: "99", right: "1px", height: "34.8387px"}}></div><div className="slimScrollRail" style={{width: "4px", height: "100%", position: "absolute", top: "0px", display: "none", borderradius: "0px", background: "rgb(51, 51, 51)", opacity: "0.2", zindex: "90", right: "1px"}}></div></div>
                </div>
                <div className="legal">
                    <div className="copyright">
                        © 2021 - 2031 <a href="#">BestCarePharmacy</a>.
                    </div>
                </div>
            </aside>
         </section>     
